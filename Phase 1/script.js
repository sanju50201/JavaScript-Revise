...
// What is a prototype -- mechanism feature which inherit features from one other

String.prototype.yell = function () {
  return `${this.toUpperCase()} !!!!!, YOU SUCK!!!`;
};
String.prototype.toUpperCase = function () {
  return 'you are lower case 🤣🤣';
};
...
const brown = new Color(122, 75, 21, 'brown');
...
// this is extended by the animals class
...
class Dogs extends Pet {
  ...
  // if a method is not present here then it calls the parent class, else it executes which is present
  eat() {
...
class Cats extends Pet {
  constructor(name, age, livesLeft = 9) {
    ...
    super(name, age); // this references to the parent class
